//  dead_time  --  calculate trigger dead time for a collider experiment
//  Copyright (C) 2018 - Fabian A.J. Thiele, <fabian.thiele@posteo.de>
//
//  This file is part of dead_time.
//
//  dead_time is free software: you can redistribute it and/or modify
//  it under the terms of the GNU General Public License as published by
//  the Free Software Foundation, either version 3 of the License, or
//  (at your option) any later version.
//
//  dead_time is distributed in the hope that it will be useful,
